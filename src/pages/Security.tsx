        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {mainSections.map((s, i) => (
              ...
              <div className="group bg-[#0b1120] border border-[#1e2d4a] rounded-2xl p-6 relative overflow-hidden h-full hover:border-[#00c3ff]/40 hover:shadow-[0_0_40px_rgba(0,195,255,0.08)] transition-all duration-500">
